...
blowfish_key = os.urandom(16) # Blowfish Algorithm Key

bf_cipher = Blowfish.new(blowfish_key, Blowfish.MODE_ECB)
...
def encryption(file_path):
    ...
    #bf_ciphertext = bf_cipher.encrypt(cipher_text)
    try:
...
def decryption(file_path):
    ...
    try:
        ...
        with open(file_path, "rb") as encrypted_file:
            # bf_cipher_text = encrypted_file.read()
            # cipher_text = bf_cipher.decrypt(bf_cipher_text)
